            ...
            <div style={{
                ...
                <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '8px', marginBottom: '30px' }}>
                    ...
                    <span style={{ fontSize: '24px', fontWeight: '800', letterSpacing: '-0.5px' }}>
                        TDTK <span style={{ color: '#4CAF50' }}>Admin</span>
                    </span>
                </div>
                ...
                <form onSubmit={handleLogin}>
                    ...
                    <button
                        ...
                        style={{
                            width: '100%',
                            padding: '14px',
                            background: loading ? '#81c784' : '#4CAF50', // Xanh lá
                            color: 'white',
                            border: 'none',
                            borderRadius: '4px',
                            fontWeight: '700',
                ...
                <div style={{ marginTop: '24px', fontSize: '12px', color: '#888' }}>
                    Bạn quên mật khẩu? <a href="#" style={{ color: '#4CAF50', textDecoration: 'none', fontWeight: '600' }}>Liên hệ IT Support</a>
                </div>
            </div>
        </div>
    );
